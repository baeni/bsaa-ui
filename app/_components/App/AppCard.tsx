...
export default function AppCard(props: Props) {
    ...
    return (
        <Link ref={cardRef} href={!isDisabled ? `/app/${props.app.title.toLowerCase()}`: {}} scroll={!isDisabled}>
            <div className={`group flex flex-col gap-5 text-black bg-neutral-50 pt-10 px-8 rounded-3xl overflow-hidden ${isDisabled && 'cursor-default'}`}>
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-lg font-semibold text-neutral-400 whitespace-pre-line leading-snug
                                  transition-all duration-300
                                  group-hover:opacity-0 group-hover:blur-sm group-hover:-translate-y-2">{props.app.description}</p>
                </div>
